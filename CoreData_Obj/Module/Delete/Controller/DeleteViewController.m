...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.actionBlock = ^{
        ...
        UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"删除？" message:@"" preferredStyle:UIAlertControllerStyleAlert];
        UIAlertAction *action = [UIAlertAction actionWithTitle:@"确定" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
            [ChatListDB.shared deleteChatListWithChannelId:model.accountId];
            [strongSelf.modelArray removeObject:model];
